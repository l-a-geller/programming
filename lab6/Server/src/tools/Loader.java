            ...
            if (field.getType().toString().contains("long")){
                ...
                while (i==0){
                    try{
                        ...
                        System.out.println("Maximum point must be greater than Minimum point, " + minimalPoint);
                    }
                }
            }
            ...
            if (field.getType().toString().contains("String")){
                ...
                while (i==0){
                    try{
                        ...
                        i = 1;
                    }catch (NumberFormatException e){ System.out.println("Field not correct, please enter data again."); }
                }
            }

            if (field.getType().toString().contains("Coordinates")){
                System.out.println("\nPlease enter Coordinates. Example: 333,8:88,0 \nFirst coordinate must be integer, in [" + (-Integer.MAX_VALUE - 1) + " : " + Integer.MAX_VALUE + "]\n" +
                ...
                while (i==0){
                    try{
                        ...
                        i = 1;
                    }catch (ArrayIndexOutOfBoundsException e){ System.out.println("Input not correct, please enter two numbers, separated by :"); }
                    catch (NumberFormatException e){ System.out.println("Field not correct, please enter data again."); }
                }
            }
            ...
            if (field.getType().toString().contains("Difficulty")){
                ...
                while (i==0){
                    ...
                    if (line.trim().equals("") || diff != null){
                        difficulty = diff;
                        i = 1;
                    }else{ System.out.println("Field not correct, please enter data again."); }
                }
            }
            if (field.getType().toString().contains("Discipline")){
                ...
                while (i==0){
                    try{
                        ...
                        System.out.println("Please provide all the elements.");
                    }catch (NumberFormatException e){
                        System.out.println("Field not correct, please enter data again.");
                    }
                }
            }
        }
